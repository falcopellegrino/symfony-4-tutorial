...
class MailerTest extends TestCase
{
    public function testConfirmationEmail()
    {
        ...
        $twigMock = $this->getMockBuilder(\Twig_Environment::class)
            ...
            ->getMock();
        // This asserts that render method is called inside mailer
//        $twigMock->expects($this->once())->method('render');
        // This asserts that render method is called inside mailer, with parameter
        $twigMock->expects($this->once())->method('render')
...
//                return true;
                return strpos($messageStr, "From: me@domain.com") !== false
                    ...
                    && strpos($messageStr, "This is AAA a message body") !== false;
            }));
